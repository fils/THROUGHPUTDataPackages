...
import (
	...
	"oceanleadership.org/frictionless/THROUGHPUTDataPackages/pkgpress/lphandler"
)
...
func main() {
	...
	searchroute.HandleFunc("/lptest", lphandler.PresentPackage) // the REAL handler for this URL
